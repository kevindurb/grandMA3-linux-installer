...
Exec=env LD_LIBRARY_PATH=$HOME/MALightingTechnology/gma3_$VERSION/shared/third_party $HOME/MALightingTechnology/gma3_$VERSION/console/bin/app_gma3 HOSTTYPE=onPC
